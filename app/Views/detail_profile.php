                    ...
                    <div class="row justify-content-center gap-4 align-items-stretch">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="custom-block bg-white shadow-lg p-3 h-100">
                                <h5 class="mb-2"><?= esc($users['nama']) ?></h5>
                                <p><?= esc($users['tempat_lahir']) ?>, <?= esc($users['tanggal_lahir']) ?></p>
                                <h5>Ketrampilan:</h5>
                                <p><?= esc($users['ketrampilan']) ?></p> 
                            </div>
                        </div>
                                    ...
                                    <div class="social-share d-flex justify-content-center mt-3">
                                        <ul class="social-icon d-flex gap-2">
                                            <li class="social-icon-item">
                                                <a href="<?= esc($users['instagram']) ?>" class="social-icon-link bi-instagram" target="_blank" rel="noopener noreferrer"></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
