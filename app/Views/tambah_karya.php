...
<body id="top">
    <main>
        ...
        <header class="site-header d-flex flex-column justify-content-center align-items-center" style="height: 80px; padding: 20px 0;"></header>

        <section class="container mt-4">
            <div class="row">
                <div class="col-lg-8 col-12 m-auto">
                <h2>Tambah Karya</h2>
                    <form action="<?= base_url('/Karya/simpan') ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="nama_karya" class="form-label">Judul Karya</label>
                            <input type="text" class="form-control" id="nama_karya" name="nama_karya" required>
                        </div>
                        <div class="mb-3">
